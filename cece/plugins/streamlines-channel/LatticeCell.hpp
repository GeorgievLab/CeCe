...
public:
    ...
    static constexpr ValueType SPEED_OF_SOUND_SQ = 1.0 / 3.0;

    /// Inversed square of speed of sound.
    static constexpr ValueType SPEED_OF_SOUND_SQ_INV = 1.0 / SPEED_OF_SOUND_SQ;
...
public:
     ...
     */
    void initVelocity(Position position, const VelocityType& velocity, ValueType omega) noexcept;
     ...
     */
    void initDensity(Position position, DensityType rho, ValueType omega) noexcept;
     ...
     */
    void initInlet(Position position, const VelocityType& velocity, ValueType omega) noexcept;
     ...
     */
    void initOutlet(Position position, ValueType rho, ValueType omega) noexcept;
...
public:
    ...
    /**
     * @brief Sum all known values.
     *
     * @return
     */
    DensityType calcSum() const noexcept;
    ...
    /**
     * @brief Calculate momentum vector.
     *
     * @return
     */
     ...
     * @return
     */
    VelocityType calcVelocity(ValueType omega) const noexcept;
    ...
    /**
     * @brief Stream node data.
     *
     * @param iPop Population index.
     * @param src  Source node.
     */
    void stream(IndexType iPop, const LatticeCell& src);
     ...
     */
    DensityType calcVelocity(Position position, const VelocityType& velocity, ValueType omega) const noexcept;
     ...
     */
    VelocityType calcDensity(Position position, DensityType rho, ValueType omega) const noexcept;
     ...
     * @return
     */
    static ValueType calcEquilibrium(ValueType weight, const Vector<int>& dirVel,
     ...
     * @return
     */
    static StaticArray<ValueType, SIZE> calcEquilibrium(const VelocityType& velocity,
        DensityType rho) noexcept;
     ...
     * @param height
     */
    static void initModel(ValueType height);
...
public:
    ...
    /// Model weights horizontal.
    static StaticArray<ValueType, SIZE> s_weights;

    /// Model weights vertical.
    static StaticArray<ValueType, SIZE> s_weightsVertical;
