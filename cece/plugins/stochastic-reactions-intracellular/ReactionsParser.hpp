...
/* ************************************************************************ */
     ...
     */
    explicit ReactionsParser(const String& code, const Parameters& parameters) noexcept
...
inline ReactionsType parseReactions(const String& code, const Parameters& parameters = Parameters{})
{
