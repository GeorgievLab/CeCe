...
static PyObject* getWorldSize(ObjectWrapper<simulator::Simulation&>* self) noexcept
{
...
static PyObject* getIteration(ObjectWrapper<simulator::Simulation&>* self) noexcept
{
...
static PyObject* getIterations(ObjectWrapper<simulator::Simulation&>* self) noexcept
{
...
static PyObject* setIterations(ObjectWrapper<simulator::Simulation&>* self, PyObject* args) noexcept
{
    int iterations;
...
static PyObject* getTimeStep(ObjectWrapper<simulator::Simulation&>* self) noexcept
{
...
static PyObject* setTimeStep(ObjectWrapper<simulator::Simulation&>* self, PyObject* args) noexcept
{
    float timeStep;
...
static PyObject* getTotalTime(ObjectWrapper<simulator::Simulation&>* self) noexcept
{
...
static PyObject* getObjectCount(ObjectWrapper<simulator::Simulation&>* self) noexcept
{
...
static PyObject* useModule(ObjectWrapper<simulator::Simulation&>* self, PyObject* args, void*) noexcept
{
    char* name;
...
static PyObject* buildObject(ObjectWrapper<simulator::Simulation&>* self, PyObject* args, void*) noexcept
{
    char* name;
...
static PyObject* objectCountType(ObjectWrapper<simulator::Simulation&>* self, PyObject* args, void*) noexcept
{
    char* name;
...
static PyObject* getParameter(ObjectWrapper<simulator::Simulation&>* self, PyObject* args, void*) noexcept
{
    char* name;
    float def = 0;
...
static PyTypeObject g_type = {
    ...
    sizeof(ObjectWrapper<simulator::Simulation>), // tp_basicsize
    0,                              // tp_itemsize
    0,                              // tp_dealloc
    0,                              // tp_print
    0,                              // tp_getattr
...
void init_simulator_Simulation(PyObject* module)
{
    ...
    // Register type.
    TypePtr<simulator::Simulation>::ptr = &g_type;
}
