...
static PyObject* getX(ObjectWrapper<core::VectorInt>* self) noexcept
{
...
static PyObject* setX(ObjectWrapper<core::VectorInt>* self, PyObject* args) noexcept
{
    int x;
...
static PyObject* getY(ObjectWrapper<core::VectorInt>* self) noexcept
{
...
static PyObject* setY(ObjectWrapper<core::VectorInt>* self, PyObject* args) noexcept
{
    int y;
...
static PyTypeObject g_type = {
    ...
    0,                              // ob_size
    "core.VectorInt",               // tp_name
    sizeof(ObjectWrapper<VectorInt>), // tp_basicsize
    0,                              // tp_itemsize
    0,                              // tp_dealloc
    0,                              // tp_print
    0,                              // tp_getattr
...
void init_core_VectorInt(PyObject* module)
{
    ...
    Py_INCREF(type);
    PyModule_AddObject(module, "VectorInt", type);
}
