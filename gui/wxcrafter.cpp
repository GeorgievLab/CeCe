    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_stcSource->Connect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(MainFrameBaseClass::OnSimulationNotRunningUpdateUi), NULL, this);
...
MainFrameBaseClass::~MainFrameBaseClass()
{
    ...
    m_stcSource->Disconnect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(MainFrameBaseClass::OnSimulationNotRunningUpdateUi), NULL, this);
