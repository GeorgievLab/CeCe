...
SET ARGS=-DCMAKE_BUILD_TYPE=release -DDEV_PHYSICS_BUILTIN_DEBUG=On -DDEV_PLUGIN_streamlines_RENDER=On -DPNG_PNG_INCLUDE_DIR="C:\Program Files (x86)\libpng\include" -DPNG_LIBRARY_RELEASE="C:\Program Files (x86)\libpng\lib\libpng16.a"
